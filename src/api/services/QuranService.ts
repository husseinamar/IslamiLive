...
export class QuranService {
    ...
    public findOneChapter(findCondition: any): Promise<QuranChapter> {
    ...
    public findAllChapters(findCondition: any): Promise<QuranChapter[]> {
        // this.log.info('Find all QuranChapters matching');
        return this.QuranChapterRepository.find(findCondition);
    }

    // list all QuranChapters
    public listChapters(limit: number = 0, offset: number = 0, select: any = [], relation: any = [], whereConditions: any = [], keyword: string, count: number | boolean, order: string = 'ASC'): Promise<QuranChapter[]> | Promise<number> {
        const condition: any = {};
    ...
    public async createChapter(QuranChapter: QuranChapter): Promise<QuranChapter> {
    ...
    public findOneVerse(findCondition: any): Promise<QuranVerse> {
    ...
    public findAllVerses(findCondition: any): Promise<QuranVerse[]> {
        // this.log.info('Find all QuranVerses matching');
        return this.QuranVerseRepository.find(findCondition);
    }

    // list all QuranVerses
    public listVerses(limit: number = 0, offset: number = 0, select: any = [], relation: any = [], whereConditions: any = [], keyword: string, count: number | boolean, order: string = 'ASC'): Promise<QuranVerse[]> | Promise<number> {
        const condition: any = {};
    ...
    // create a new verse
    public async createVerse(QuranVerse: QuranVerse): Promise<QuranVerse> {
